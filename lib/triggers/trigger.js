/**
 * Auto-generated trigger file for "Craftboxx Plan it API" API.
 * Generated at: 2022-06-28T09:14:06.503Z
...
function processTrigger(msg, cfg, snapshot, incomingMessageHeaders, tokenData) {
  ...
  return Swagger.execute(callParams).then( async (data) => {
    ...
    if(skipSnapshot){
      ...
      await dataAndSnapshot(newElement,snapshot,snapshotKey, 'end', this);
    }
  });
}
